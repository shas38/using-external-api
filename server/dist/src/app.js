...
var movieNames_1 = require("./routes/movieNames");
var movieDetails_1 = require("./routes/movieDetails");
...
app.use('/api/movies', movieNames_1.default); // Connect the /api/currencies route to the route handling function stored /routes/currencies
app.use('/api/movie', movieDetails_1.default); // Connect the /api/currencies route to the route handling function stored /routes/currencies
