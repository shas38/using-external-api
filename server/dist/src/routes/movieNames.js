...
var processMovieNames_1 = require("../services/processMovieNames");
...
*/
var processMovieNames = new processMovieNames_1.default()
...
router.get('/', function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, processMovieNames.generateMovieList()];
            case 1:
                result = _a.sent();
                // console.log(result)
...
//# sourceMappingURL=movieNames.js.map