...
var processMovieDetails_1 = require("../services/processMovieDetails");
...
router.post('/', function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, processMovieDetails.generateMovieDetails(req.body)];
            case 1:
                result = _a.sent();
                // console.log(name)
